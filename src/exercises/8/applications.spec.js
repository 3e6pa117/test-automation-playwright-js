...
import { ApplicationPage } from "./pages/applications.page.js";
...
test.describe("Applications Page", async () => {
    ...
    test.beforeEach(async ({page}) => {
        ...
        const applicationsPage = new ApplicationPage(page);
        await applicationsPage.goTo();
        await applicationsPage.waitForTableToLoad();
        await expect(applicationsPage.getPageTitle()).toMatch(pageTitle);
    });

    test("should list all applications", async ({ page }) => {
        // get all rows
        const applicationsPage = new ApplicationPage(page);
        allRows = applicationsPage.getApplicationsTableRows();
    ...
    test("should filter in applications", async ({ page }) => {
        ...
        // search in table
        await searchInApplicationsTable(page, 'Lada');
